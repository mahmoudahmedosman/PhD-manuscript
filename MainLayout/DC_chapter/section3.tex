...
As part of my PhD work, I led of the analysis of pre-DC1, a slightly different version of the \textsc{Lemaître} DC1 where we use a SALT model that respects the NaCl constraints 
to generate the supernova light curves. This allows us to remain coherent in assessing whether the pipeline introduces internal biases at the level of the 
model training or not. 
