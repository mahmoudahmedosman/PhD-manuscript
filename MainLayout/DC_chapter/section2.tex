...
\begin{itemize}
    ...
    \item The cosmology that was used is Planck18 found in astropy.cosmology ($\Omega_m=0.30966$) (ref).
    ...
    \item The rate of the supernovae were chosen to be Frohmaier+19 (ref).
    \item The milky way dust extinction was drawn out from the Planck dust map (ref) and the $E(B-V)_{MW}$ values follow the CM89 dust law (ref).
