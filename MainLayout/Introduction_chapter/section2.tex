...
\begin{equation}
    \mathcal{P}_{\mathrm{lin}}(t, k) = A_0 k^{n_s}T^2(k)D^2_+(t)
\end{equation}
with $A_0$ the normalization parameter and $T(k)$ is the transfer function which characterizes how each Fourrier mode of the density field evolved from the initial conditions to 
a later time. \\
