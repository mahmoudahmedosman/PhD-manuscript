...
It is meant to be easy to use and manipulate in order to account for any new developments in how spectrophotmetric models are parameterized. 
...
This parameterization, like SALT2, is a classic principal component analysis, or PCA, with the addition of a color law. The main differences with SALT models is in 
...
fitted beforehand. The reason why in NaCl we do that is to account for the possible changes of $t_{max}$ that may arise due to the changes in the spectrophotmetric model
during the training. \\
