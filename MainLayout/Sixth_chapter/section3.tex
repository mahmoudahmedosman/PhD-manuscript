\section{Uchuu-ZTF mocks}

\subsection{ZTF peculiar velocity data challenge (DC PV)}
...
LEMAITRE pipeline. One could assume that in more complicated analyses that the Tripp relation parameters ($\alpha$, $\beta$) would be sampled in BORG. 
...
\subsection{Supernova forward-model analysis}
