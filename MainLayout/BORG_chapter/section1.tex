...
Their detection would provide valuable insight into the physics of inflation, as different inflationary scenarios predict distinct non-Gaussian signatures. 
...
jointly infer the initial conditions and the local primordial non-Gaussianity parameter $f_{\mathrm{NL}}$. 
...
uncertainty on $f_{\mathrm{NL}}$. The inference was also tested on multiple gravity solvers to assess the impact of resolving for small-scales on the measurement of $f_{\mathrm{NL}}$.
